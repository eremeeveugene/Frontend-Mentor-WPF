    ...
    ProfileCardComponentBindableModel.Parameters parameters) : BindableBase
{
    ...
    {
        get;
    } = parameters.Profile.Location;

    public string FirstName
    {
        get;
    } = parameters.Profile.FirstName;

    public string LastName
    {
        get;
    } = parameters.Profile.LastName;

    public int Age
    {
        get;
    } = parameters.Profile.Age;

    public int Followers
    {
        get;
    } = parameters.Profile.Followers;

    public int Likes
    {
        get;
    } = parameters.Profile.Likes;

    public int Photos
    {
        get;
    } = parameters.Profile.Photos;
