...
internal sealed class HomeTabItemViewModel : TabItemViewModel, IHomeTabItemViewModel
{
    public HomeTabItemViewModel(IHomeTabItemView homeTabItemView) : base(homeTabItemView)
    {
    }
